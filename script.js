$(document).ready(function () {
    ...
    function displayCookieConsent() {
        ...
        // Add message text
        var message = 'This website uses cookies to ensure you get the best experience. By continuing to use this site, you accept our use of cookies.';

        // Create accept and deny buttons
        var acceptButton = $('<button>').addClass('cookie-consent-accept').text('Accept');
    ...
    $("#dp-dots li").click(function () {
        ...
        $("#dp-slider .dp_item[data-class=" + getSlide + "]").hide().prependTo("#dp-slider").fadeIn();
        $.each($('.dp_item'), function (index, dp_item) {
            $(dp_item).attr('data-position', index + 1);
        });
    });
